...
PM_START_TEXT = """
Hello there, I'm [Blackhatofficialbot](https://telegra.ph/file/106c44facacdf2b202f5c.png)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add Blackhatofficialbot to your group 💫", url="t.me/daisyXBot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [🤖](https://telegra.ph/file/106c44facacdf2b202f5c.png)
...
Support them  [DarkSide](t.me/im_mr_dark_side)"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by Dark Side.* "
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/106c44facacdf2b202f5c.png)"
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is the redisigned version of Daisy  for the best performance.*"
